...
var ChartTool = {
  ...
  make: function () {
    ...
    var chartOptions = ['<a href="#" style="float:left;display:none;" id="showInfo">&#187; Show Site Info</a>',
      ...
      '<span style="float:left">All Sites:</span><span style="float:right;width:60px;padding:5px;text-align:center;box-sizing:content-box;">Selected:</span><br>',
    ...
    var introHtml = ['<div style="text-align:center;font-size:24px;"><strong>Welcome to MGViz - the MMGIS GNSS Visualizer</strong></div><br></br>',
      ...
      'Selected sites will show up under the <strong>Selected</strong> list. Deselecting the <strong>Append Site Selection</strong> ',
